...
export default {
  ...
  oseReleaseToUnionAdd: '新增',
  oseReleaseToUnionEdit: '编辑',
  oseReleaseToUnionDetail: '详情',
  inputQuotaDetail: '投入品配额详情',
  unionReceiveDetail: '详情',
  woredaReceive: 'Woreda接收详情',
  woredaTokebele: 'Woreda分发投入品到Kebele',
  kebeleReceive: 'Kebele确认接收',
  kebeleTofarmer: 'Kebele分发投入品到农民',
  farmerReleaseAdd: '新增农民分发',
  farmerReleaseEdit: '编辑农民分发',
  farmerReleaseDetail: '农民分发详情',
