export default {
  ...
  targetCooperative: '目标Cooperative',
  cooperativeAddress: 'Cooperative收货地址',
  cooperativeContact: 'Cooperative联系人',
  cooperativePhone: 'Cooperative联系电话',
  ...
  queryCooperativeListFailed: '获取Cooperative列表信息失败',
  getWoredaInfoFailed: '获取Woreda信息失败',
  getKebeleInfoFailed: '获取Kebele信息失败',
  getCooperativeInfoFailed: '获取Cooperative信息失败',
